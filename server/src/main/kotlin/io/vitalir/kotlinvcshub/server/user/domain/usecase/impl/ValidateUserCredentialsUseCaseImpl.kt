...
// TODO: Separate validation rules to new classes
internal class ValidateUserCredentialsUseCaseImpl : ValidateUserCredentialsUseCase {

    override suspend fun invoke(userCredentials: User.Credentials): Either<UserError.ValidationFailed, Unit> = either {
        validateIdentifier(userCredentials.identifier).bind()
    }
